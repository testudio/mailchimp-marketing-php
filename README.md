...
The fork of [official PHP client library for the Mailchimp Marketing API](https://github.com/mailchimp/mailchimp-marketing-php) made compatible with 
[Drupal 9](https://www.drupal.org/project/mailchimp_marketing) until this [pull request](https://github.com/mailchimp/mailchimp-marketing-php/pull/11) is resolved.
